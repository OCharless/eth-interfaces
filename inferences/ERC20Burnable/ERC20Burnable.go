...
func (_ERC20Burnable *ERC20BurnableCaller) InitialSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ERC20Burnable.contract.Call(opts, &out, "initialSupply")
...
//
// Solidity: function initialSupply() view returns(uint256)
func (_ERC20Burnable *ERC20BurnableSession) InitialSupply() (*big.Int, error) {
	return _ERC20Burnable.Contract.InitialSupply(&_ERC20Burnable.CallOpts)
}

// InitialSupply is a free data retrieval call binding the contract method 0x378dc3dc.
//
// Solidity: function initialSupply() view returns(uint256)
func (_ERC20Burnable *ERC20BurnableCallerSession) InitialSupply() (*big.Int, error) {
	return _ERC20Burnable.Contract.InitialSupply(&_ERC20Burnable.CallOpts)
}
...
func (_ERC20Burnable *ERC20BurnableTransactor) Mint(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Burnable.contract.Transact(opts, "mint", to, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 amount) returns()
func (_ERC20Burnable *ERC20BurnableSession) Mint(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Burnable.Contract.Mint(&_ERC20Burnable.TransactOpts, to, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address to, uint256 amount) returns()
func (_ERC20Burnable *ERC20BurnableTransactorSession) Mint(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _ERC20Burnable.Contract.Mint(&_ERC20Burnable.TransactOpts, to, amount)
}
...
func (_ERC20Burnable *ERC20BurnableTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ERC20Burnable.contract.Transact(opts, "renounceOwnership")
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_ERC20Burnable *ERC20BurnableSession) RenounceOwnership() (*types.Transaction, error) {
	return _ERC20Burnable.Contract.RenounceOwnership(&_ERC20Burnable.TransactOpts)
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_ERC20Burnable *ERC20BurnableTransactorSession) RenounceOwnership() (*types.Transaction, error) {
	return _ERC20Burnable.Contract.RenounceOwnership(&_ERC20Burnable.TransactOpts)
}
...
func (_ERC20Burnable *ERC20BurnableFilterer) FilterPaused(opts *bind.FilterOpts) (*ERC20BurnablePausedIterator, error) {

	logs, sub, err := _ERC20Burnable.contract.FilterLogs(opts, "Paused")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Paused(address account)
func (_ERC20Burnable *ERC20BurnableFilterer) WatchPaused(opts *bind.WatchOpts, sink chan<- *ERC20BurnablePaused) (event.Subscription, error) {

	logs, sub, err := _ERC20Burnable.contract.WatchLogs(opts, "Paused")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_ERC20Burnable *ERC20BurnableFilterer) FilterUnpaused(opts *bind.FilterOpts) (*ERC20BurnableUnpausedIterator, error) {

	logs, sub, err := _ERC20Burnable.contract.FilterLogs(opts, "Unpaused")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Unpaused(address account)
func (_ERC20Burnable *ERC20BurnableFilterer) WatchUnpaused(opts *bind.WatchOpts, sink chan<- *ERC20BurnableUnpaused) (event.Subscription, error) {

	logs, sub, err := _ERC20Burnable.contract.WatchLogs(opts, "Unpaused")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
